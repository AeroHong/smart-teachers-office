...
const ALLOWED_ATTR = [
  ...
  // 채널 메시지의 #채널 · @사람 · @전체 인라인 조각(channelMentionChip.js) — 같은
  // 이유로 contenteditable="false"를 함께 쓴다.
  'data-channel-ref', 'data-mention-uid', 'data-mention-name', 'data-mention-channel',
