...
curl -fsSL "https://smart-school-updates.web.app/smart-office-codesign.cer" -o "%WORKDIR%\cert.cer"
if errorlevel 1 (
...
curl -fsSL "https://smart-school-updates.web.app/smart-office-setup-latest.exe" -o "%WORKDIR%\setup.exe"
if errorlevel 1 (
  echo Download failed. Check your network connection and try again.
  pause
  exit /b 1
